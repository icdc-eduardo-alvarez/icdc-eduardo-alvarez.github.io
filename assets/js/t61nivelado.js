...
function init() {
  ...
  loader.load('./assets/models/T6.1-Chasis_nivelado.glb', gltf => {
    ...
    let total = xhr.lengthComputable ? xhr.total : parseInt(xhr.target.getResponseHeader('content-length'), 10);
